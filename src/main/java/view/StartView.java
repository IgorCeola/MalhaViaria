...
public class StartView extends javax.swing.JFrame  {
    ...
    public StartView() {
        ...
        Posicionamento.centerFrame(StartView.this);
        initComponents();
    }
    ...
    private ModoSelecionado getModoSelecionado() {
        if (monitorRadioBtn.isSelected()) {
            return ModoSelecionado.MONITOR;
        } else if (semaphorRadioBtn.isSelected()){
            return ModoSelecionado.SEMAFORO;
        } else {
            return null;
        }
    }
    ...
    private void startBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBtnActionPerformed
        this.controller.handleModoSelecionado(getModoSelecionado());
