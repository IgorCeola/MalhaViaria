...
import tabelaMalha.RenderizadorCelulaMalha;
import tabelaMalha.TableModelMalha;
import view.TelaMalha;
//import presentation.view.UpdatableTelaMalha;

public class TelaMalha extends javax.swing.JFrame{

	private final ControllerSimulador controller;
    private final TableModelMalha tableModel = new TableModelMalha();
  
    public TelaMalha() {
        initComponents();
        this.controller = new ControllerSimulador(TelaMalha.this);
        applyDefaults();
    }
    ...
    private void applyDefaults() {
        ...
        jTable1.setDefaultRenderer(ConstantesCelula.class, new RenderizadorCelulaMalha());   
